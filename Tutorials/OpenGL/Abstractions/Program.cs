...
using SilkNetExamples.Tutorials.OpenGL.Abstractions;
...
internal sealed class Program
{
  ...
  public static SilkNetExamples.Tutorials.OpenGL.Abstractions.Texture Texture { get; private set; }
  private static SilkNetExamples.Tutorials.OpenGL.Abstractions.Shader _shader;
  ...
  private static void OnLoad()
  {
    ...
    _shader = new SilkNetExamples.Tutorials.OpenGL.Abstractions.Shader(
      _gl,
      "Resources/Shaders/vertexCode.glsl",
      "Resources/Shaders/fragmentCode.glsl"
    );

    Texture = new SilkNetExamples.Tutorials.OpenGL.Abstractions.Texture(_gl, "Resources/Images/silk.png");
  }
